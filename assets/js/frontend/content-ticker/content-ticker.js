...
var ContentTicker = function ContentTicker($scope, $) {
	var $contentTicker = $scope.find(".rael-content-ticker").eq(0),
...
jQuery(window).on("elementor/frontend/init", function () {
	elementorFrontend.hooks.addAction("frontend/element_ready/rael-content-ticker.default", ContentTicker);
});
