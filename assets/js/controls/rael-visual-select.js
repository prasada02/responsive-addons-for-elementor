...
(function ( $, window, document, undefined ) {
	...
	var pluginName = 'raelVisualSelect',
		defaults   = {
			item             : 'rael-select-item',              // visual select item [class name].
			selected         : 'rael-selected',                 // selected item [class name].
			caption          : 'rael-select-caption',           // caption under visual item [class name].
			container        : 'rael-visual-select',            // select items container [class name].
