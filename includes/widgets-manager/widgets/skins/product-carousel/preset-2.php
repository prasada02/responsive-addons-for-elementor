			...
			<div class="rael-pc__product-image-wrapper">
				<div class="rael-pc__product-image">
					...
					if ( $show_image_clickable ) {
						echo '<a href="' . esc_html( $product->get_permalink() ) . '" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">';
					}
				...
				<div class="rael-pc__image-hover-wrapper">
					<ul class="rael-pc__icons-wrapper rael-pc-box-style-list">
