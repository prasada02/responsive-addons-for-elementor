...
?>
	...
	?>
		<style type="text/css">
			<?php echo '.rael-grid-item-content:hover .', esc_html($animation_name); ?>>p,
			/* variable escaped before hand. */
			<?php echo '.rael-grid-item-content:hover .', esc_html($animation_name); ?>><?php echo esc_html(Helper::validate_html_tags($caption_tag)); ?> {
				animation:
					<?php echo esc_html($animation_name), '-in'; ?> <?php echo esc_html($animation_speed), 'ms'; ?> ease-out;
			}
			...
			<?php echo '.rael-grid-item-content:not( :hover ) .', esc_html($animation_name); ?>><?php echo esc_html(Helper::validate_html_tags($caption_tag)); ?> {
				animation:
					<?php echo esc_html($animation_name), '-out'; ?> <?php echo esc_html($animation_speed), 'ms'; ?> ease-out;
			}
