<?php
/**
 * File containing abstract class Responsive_Addons_For_Elementor_Woo_Products_Base.
 *
...
/**
 * Abstract base class for WC Products in Responsive Addons for Elementor.
 */
abstract class Responsive_Addons_For_Elementor_Woo_Products_Base extends Woo_Widget_Base {
	 ...
	 * @since 1.8.0
	 *
	 * @param string $string setting array.
