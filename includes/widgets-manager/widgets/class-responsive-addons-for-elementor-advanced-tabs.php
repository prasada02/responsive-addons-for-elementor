...
?>
	...
	{
		// Ensure Elementor icons load when widget renders templates
				...
				?>
					...
					<div class="clearfix <?php echo esc_attr($tab['rael_advanced_tabs_tab_show_as_default']); ?>">
						...
						elseif ('image' === $tab['rael_advanced_tabs_text_type']) : {
							...
							<?php }
						elseif ('template' === $tab['rael_advanced_tabs_text_type']) : ?>
							<?php
							if (! empty($tab['rael_primary_templates'])) {
								$allowed_html          = wp_kses_allowed_html('post');
								$allowed_html['style'] = true;
								echo Plugin::$instance->frontend->get_builder_content_for_display($tab['rael_primary_templates']);
							}
							?>
						<?php endif; ?>
					</div>
