...
// RAEL_HF_Admin
if ( ! class_exists( 'Responsive_Addons_For_Elementor_Theme_Builder_Admin' ) ) {
	/**
	 * Responsive_Addons_For_Elementor_Theme_Builder_Admin Class.
	 *
	 * @since 1.3.0
	 */
	class Responsive_Addons_For_Elementor_Theme_Builder_Admin {
